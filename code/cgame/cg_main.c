...
static cvarTable_t cvarTable[] = { // bk001129
...
#else {&cg_deferPlayers, "cg_deferPlayers", "1", CVAR_ARCHIVE},
#endif
	...
	{&cg_leiEnhancement, "cg_leiEnhancement", "0", CVAR_ARCHIVE},default off(in case of whiner) {&cg_leiGoreNoise, "cg_leiGoreNoise", "0", CVAR_ARCHIVE},
...
static void CG_RegisterSounds(void) {
	...
	if (((cgs.gametype >= GT_TEAM) && (cgs.ffa_gt != 1)) || cg_buildScript.integer) {
