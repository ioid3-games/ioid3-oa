...
#ifndef DEDICATED
	if (!SDL_VIDEODRIVER_externallySet) {
		// It's a little bit weird having in_mouse control the video driver, but from ioq3's point of view they're virtually the same except for the mouse input anyway
