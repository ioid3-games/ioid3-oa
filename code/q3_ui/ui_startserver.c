...
static qboolean BotAlreadySelected(const char *checkName) {
	...
	for (n = 1; n < PLAYER_SLOTS; n++) {
		...
		if ((s_serveroptions.gametype >= GT_TEAM) && s_serveroptions.gametype != GT_LMS && s_serveroptions.gametype != GT_POSSESSION && (s_serveroptions.playerTeam[n].curvalue != s_serveroptions.playerTeam[s_serveroptions.newBotIndex].curvalue)) {
			continue;
		}
...
//	trap_Cvar_SetValue("dedicated", Com_Clamp(0, 2, dedicated));
	...
	// set player's team
	if (/*dedicated == 0 &&*/ s_serveroptions.gametype >= GT_TEAM && s_serveroptions.gametype != GT_LMS && s_serveroptions.gametype != GT_POSSESSION) {
